...
say_this = "Cómo hacer yo Goto terminal 4, puerta 12 "
time.sleep(3)
...
"""
fn = 'output_'+'translate_1'+'.wav'
with open(join(dirname(__file__), 'Audio\\'+fn), 'wb') as audio_file:
    audio_file.write(text_to_speech.synthesize(say_this,voice='es-ES_EnriqueVoice'))
"""
time.sleep(3)
